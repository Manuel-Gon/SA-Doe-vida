    ...
    <div>
      <NavBar />
       ...
       <div className='titulo-four-pages'>
        ...
        <ul>
            <li><strong>Ana Silva</strong> - Atriz e apresentadora conhecida, Ana tem sido uma grande defensora da doação de sangue e usa suas redes sociais para incentivar seus seguidores a doar.</li>
            <li><strong>Lucas Andrade</strong> - Jogador de futebol, Lucas compartilhou sua experiência de doar sangue pela primeira vez e inspirou muitos fãs a seguirem seu exemplo.</li>
            <li><strong>Mariana Costa</strong> - Influenciadora digital, Mariana criou uma série de vídeos mostrando o passo a passo da doação, quebrando mitos e incentivando uma geração mais jovem a participar.</li>
            <li><strong>DJ Pedro Lima</strong> - Conhecido por suas músicas animadas, Pedro se uniu à campanha com um show beneficente, onde todos os ingressos foram convertidos em doações para hemocentros.</li>
            <li><strong>Fernanda Oliveira</strong> - Jornalista e apresentadora de TV, Fernanda sempre traz histórias emocionantes sobre doadores e receptores, ajudando a sensibilizar o público.</li>
        </ul>
