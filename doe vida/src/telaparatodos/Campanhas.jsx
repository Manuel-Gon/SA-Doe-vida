    ...
    <div>
        <NavBar />
         <div className="container">
            ...
            <p> Se você tem entre 16 e 69 anos, pesa mais de 50kg e está em boas condições de saúde, você pode ser um doador. Não é necessário estar em jejum, e todo o processo é rápido e seguro.</p>
            <h3>Por que doar?</h3>
            <p>Porque, além de salvar vidas, a doação de sangue é um gesto de amor ao próximo. Pessoas que passam por cirurgias, acidentes ou tratamentos médicos, como quimioterapia, muitas vezes precisam de transfusões regulares para sobreviver.
            ...
            <p>Basta procurar o hemocentro mais próximo da sua casa e fazer a sua doação. Agende seu horário e compartilhe essa mensagem com amigos e familiares. Quanto mais pessoas participarem, mais vidas podemos salvar.
